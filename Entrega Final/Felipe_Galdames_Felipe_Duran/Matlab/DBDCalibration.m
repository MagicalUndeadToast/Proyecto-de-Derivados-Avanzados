function [parametros,SigmaEmpirico,tfinal,tpromedio,OptionValueEmpirico] = ...
...
switch opcion
    case{'Primer Dia'}
        ...
        Price=PreciosEmpiricos(Spot,Strike,r,q,Tiempo...
            ,parametros(1,1),parametros(1,2),parametros(1,3),parametros(1,4)...
            ,parametros(1,5),1);
    ...
    case{'Fechas'}
        ...
        for i=finicial:ffinal
            if i==finicial
                ...
                Price=PreciosEmpiricos(Spot,Strike,r,q,Tiempo...
                    ,parametros(i,1),parametros(i,2),parametros(i,3),parametros(i,4)...
                    ,parametros(i,5),i);
                if(i==1)
                    OptionValueEmpirico=Price;
                else
